...
\title{Governing through patronage: the bargain for education in municipalities of Brazil}
\date{\today}

\author{Galileu Kim}
\affil{DIME, World Bank}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{plots/descriptive_staff_breakdown.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{plots/hist_turnover_index.pdf}
