...
% what do I need to bring the audience onboard?
% emphasize the existence of discretion, turnover, political manipulation of public resources.
% in particular the existence of power-sharing arrangements between elected officials that go beyond electoral concerns

Across the world, vulnerable populations rely on governments for access to basic public services such as education. In the developing world, the quality of public education remains low: functional illiteracy is widespread, and basic mathematical operations beyond the reach of many \citep{vegas_raising_2007}. The World Bank refers to this phenomenon as ``learning poverty'': stunted learning even when access to schooling exists.\footnote{For more information, see \hyperlink{here}{https://www.worldbank.org/en/topic/education/brief/learning-poverty}.} There is growing recognition of the role bureaucratic institutions play in shaping these outcomes \citep{pepinsky_bureaucracy_2017,finan_personnel_2015}, but the relationship between politicians, bureaucrats and the quality of public services is less clear.

In particular, there is widespread debate whether political actors' discretion over bureaucratic institutions can have positive or negative consequences for public services. On the one hand, a large literature on state capacity has argued that political interference has detrimental consequences for state capacity and public goods provision \citep{evans_bureaucracy_1999,kohli_state-directed_2004, akhtari_political_2015}. On the other, recent studies have highlighted how greater political control can have a positive effect, as increased political oversight and credit claiming can lead to better developmental outcomes \citep{gulzar_politicians_2017, raffler_does_2016}. This dichotomy between politicians and bureaucrats frames our understanding of bureaucratic quality \citep{grindle_jobs_2012}, but unpacking this relationship requires taking a step in and out, recognizing the multiplicity of actors and institutions that frame the political administration of public services \citep{centeno_unpacking_2017}.

In much of the developing world, political actors do not govern or manage alone. Particularly in developing democracies, the political landscape is composed of multiple elected officials and power-sharing arrangements which ultimately shape the political nexus between elected officials and bureaucratic institutions \citep{francois_how_2015}. In the context of a separation of powers, the need for alignment between executive and legislative actors can give rise to political competition and the need to form coalitions that allow executive leaders to govern and implement their policy agenda \citep{cameron_models_2004, gottlieb_countervailing_2019}. Where programmatic commitments are weak, this coalition-formation -- known as presidential coalitionism --  manifests itself as transactions in the form of patronage appointments to help secure votes by legislators \citep{power_optimism_2010, amorim_neto_presidential_2000}. Appointments into education, due to their high social prestige and potential for electoral mobilization \citep{oliveros_making_2016}, can be particularly valuable.

These patronage transactions between political elites have important consequences for bureaucratic institutions. As noted by \citet{evans_embedded_1995}, one feature of high-performing bureaucracies is their cohesion: an ability to retain and select personnel without being exposed to cycles of disruption. Patronage appointment 
...
Brazil's local level of government is composed of over 5 thousand municipalities, each with their own mayorship (\emph{prefeitura}) and city council (\emph{c\^{a}mara dos vereadores}). Mayors and city councillors (\textit{vereadores}) are democratically elected every four years, open to reelection for both offices.\footnote{The last municipal elections were in 2016. These take place every 4 years.} The executive is responsible for the management of public services such as education, with exclusive rights over public administration in general, and personnel appointment in particular \citep{akhtari_political_2015,brollo_victor_2017}. As noted by \citet{souza_reforma_2004}, decisions over whom to appoint into the educational sector are primarily in the hands of the mayor and her secretary of education. The city council, on the other hand, oversees legislation and approves the budget for the fiscal year, providing a local checks and balances on the executive.

At the federal level, this instituitonal arrangement gives rise to a phenomenon dscribed as presidential coalitionism \citet{raile_executive_2011, power_optimism_2010}. Executive leaders garner legislative support from the National Congress by exchanging key positions in the federal bureaucracy, appointing members of their legislative coalition into cabinet positions. \citep{raile_executive_2011}. In a setting characterized by weak party cohesion and programmatic commitments \citet{ames_electoral_1995, lucas_ideological_2010}, bureaucratic positions for members of the coalition provide material incentives for legislators to support the executive agenda \citet{batista_o_2013, neto_presidential_2006, figueiredo_executivo_1999}.
...
\begin{figure}[h]
    \centering
    \includegraphics[]{plots/saeb_map.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{plots/descriptive_staff_turnover.pdf}
