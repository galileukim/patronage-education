...
Across the world, vulnerable populations rely on governments for access to basic public services such as education. In the developing world, the quality of public education remains low: functional illiteracy is widespread, and basic mathematical operations beyond the reach of many \citep{vegas_raising_2007}. The World Bank refers to this phenomenon as ``learning poverty'': stunted learning when access to a schooling exists.\footnote{For more information, see \hyperlink{here}{https://www.worldbank.org/en/topic/education/brief/learning-poverty}.} These outcomes result from political choices, but a growing body of literature recognizes the important role bureaucratic institutions mediating these outcomes \citep{pepinsky_bureaucracy_2017,finan_personnel_2015}.

Understanding how these political decisions cascade down the bureaucracy remains a challenge. Public services -- and their quality -- are the end-result of a series of interlocking steps: from personnel decisions to service provision \citep{pepinsky_bureaucracy_2017}, each link in this institutional chain of command connects political principals to the child sitting in the classroom. This panorama of decisions belie a multiplicity of actors that is often obscured in prevailing models of 
