...
Teachers and school principals are responsible for providing all educational services at the local level. As of 2016, in the municipal education system there were 3.7 million teachers distributed across the national territory, as well as 148 thousand school principals. A majority of teachers are hired with a permanent contract (\emph{estatutário}) Over the past decade, there has been an increasing 

\begin{table}[t]
    \input{results/descriptive_teacher}
    \caption{\textbf{Summary statistics for municipal teachers.} All statistics take as reference year 2017 as reference.}
\end{table}
